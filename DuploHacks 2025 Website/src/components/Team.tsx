...
const images = {
  ...
  OwenWu: new URL('../assets/Owenwu.webp', import.meta.url).href,
  ...
  Vijay: new URL('../assets/vijay.webp', import.meta.url).href,
  ...
  Bowen: new URL('../assets/bowen.webp', import.meta.url).href,
